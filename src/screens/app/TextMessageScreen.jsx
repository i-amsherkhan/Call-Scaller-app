          ...
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={true}>
            <DataTable className="px-2 flex-1 h-full">
              ...
              <DataTable.Row className="bg-white py-5">
                ...
                <TouchableOpacity>
                  <DataTable.Cell className="py-2 h-10 rounded-md px-2 bg-green-500 items-center justify-center left-2">
                ...
                <Pressable>
                  <DataTable.Cell className="w-20 items-center justify-center left-8">
                    <TouchableOpacity
                      className="bg-blue-500 py-1 px-2 w-20 rounded"
                      onPress={() => setModalVisible(true)}
                    >
                      <Text className="truncate text-white text-center">
                        Read Me!
                      </Text>
                    </TouchableOpacity>
                  </DataTable.Cell>
